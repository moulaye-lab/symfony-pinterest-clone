...
class PinsController extends AbstractController
{
     ...
     */
    public function delete(Pequest $request,Pin $pin,EntityManagerInterface $manager) : Response
    {
        if ($this->isCsrfTokenValid('pin_deletion'.$pin->geId(), $request->request->get('csrf_token'))) {
